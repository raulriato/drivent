...
import { createEnrollmentWithAddress, createUser, createTicket, createTicketTypeWithHotel, createPayment, createHotel, createRoom, createTicketType } from "../factories";
...
describe("GET /hotels", () => {
  ...
  describe("when token is valid", () => {
    it("should respond with status 401 if the user doesn't have the credentials to get hotels data", async () => {
